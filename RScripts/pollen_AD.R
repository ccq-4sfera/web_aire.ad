...
# PARAMETERS ----
new_data_file = "/var/rprojects/DATA/polen_example.csv"
...
write.csv(historic_updated, file=historic_file, row.names=F)
...
#TODO columna especificant si es polen o espora
#TODO nom en catala
#TODO start i end setmana com a columna 
#TODO pujar la taula al raven
